...
public class AutonDirector { // replaces seenoevil, hopefully
    ...
    public Command runSpline(Trajectory trajectory) {
        ...
        return Commands.runOnce(() -> m_robotDrive.resetPoseMeters(trajectory.getInitialPose())).andThen(ramseteCommand)
    ...
    public Command balanceAuton(Supplier<DifferentialDriveWheelSpeeds> wheelSpeeds,
    ...
    public Command balanceAutonAndShootCube(Supplier<DifferentialDriveWheelSpeeds> wheelSpeeds,
        ...
        var command = new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                        ...
                        new SequentialCommandGroup(
                                new WaitCommand(RobotMap.Component.arm.armPivotSubsystem
                                        .c_holdRotation(180 - 15, 150, 200).getSecond()),
                                RobotMap.Component.intake.c_holdVoltage(4.5).withTimeout(0.5),
                                RobotMap.Component.arm.armPivotSubsystem.c_holdRotation(0, 150, 150).getFirst()
                                        .withTimeout(0.8)),
                        new SequentialCommandGroup(
    ...
    public Command newShootBalanceAuton() {
        var command = new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                        ...
                        new SequentialCommandGroup(
                                new WaitCommand(RobotMap.Component.arm.armPivotSubsystem
                                        .c_holdRotation(180 - 15, 150, 200).getSecond() + 0.5),
    ...
    public Command splineTest() {
        var command = new SequentialCommandGroup(
                runSpline(getTrajectory("straight_forward")));
        return command;
    }
