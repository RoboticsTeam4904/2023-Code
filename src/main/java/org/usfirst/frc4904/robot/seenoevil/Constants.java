...
public final class Constants {
  public static final class DriveConstants {
    ...
    // public static final double kTrackwidthMeters = RobotMap.Metrics.Chassis.TRACK_WIDTH_METERS;
    ...
    // // TODOTODOTODOTODOTODTODOTDOTODTODTODTODOTDOTDOTOTDOTOTDDTODTODTOTDO
  ...
  public static final class AutoConstants {
    public static final double kMaxSpeedMetersPerSecond = 6.0; // max like 6mps
